...
var Toolbar = function (_React$Component) {
  ...
  function Toolbar(props) {
    ...
    _this.toggleTargetBlank = _this.toggleTargetBlank.bind(_this);
    _this.handleLinkInput = _this.handleLinkInput.bind(_this);
    _this.hideLinkInput = _this.hideLinkInput.bind(_this);
    _this.persistChange = _this.persistChange.bind(_this);
    return _this;
  }
  ...
  _createClass(Toolbar, [{
    ...
    value: function componentDidUpdate() {
      ...
      */
      toolbarNode.style.top = selectionBoundary.top - parentBoundary.top - 45 + 'px';
      toolbarNode.style.width = '290px';
      var widthDiff = selectionBoundary.width - 290;
    ...
    key: 'persistChange',
    value: function persistChange(e) {
      var _this2 = this;
    ...
    key: 'toggleTargetBlank',
    value: function toggleTargetBlank(e) {
      e.preventDefault();
      e.stopPropagation();
      var targetBlank = this.state.targetBlank;

      targetBlank = !targetBlank;
      this.setState({ targetBlank: targetBlank });
    }
  }, {
    key: 'render',
    value: function render() {
      ...
      var targetBlank = _state.targetBlank;
      ...
      var linkClasses = ['hint--top', 'hint--rounded', 'md-url-open-new'];
      if (targetBlank) linkClasses = [].concat(_toConsumableArray(linkClasses), ['md-url-open-new-active']);
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'span',
            { className: 'md-url-input-close', onMouseDown: this.persistChange },
            'OK'
          ),
          _react2.default.createElement(
            'span',
            ...
            targetBlank,
            _react2.default.createElement('i', { className: 'zmdi zmdi-open-in-new' })
          ),
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement('i', { className: 'zmdi zmdi-link' })
          )
        )
      );
    }
